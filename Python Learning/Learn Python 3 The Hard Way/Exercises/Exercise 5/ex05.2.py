...
height_int = int(height)  # to not change the printed strings to floating numbers
weight = 180.0  # lbs (in floating point for conversion)
weight_int = int(weight)  # to not change the printed strings to floating numbers
eyes = 'Blue'
teeth = 'White'
hair = 'Brown'
...
print(f"He is also {int(round(height_in_cm // 100))} meters and {int(round(height_in_cm % 100))} centimeters tall")
